                        ...
                        <div class="card-body pb-1">
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="{{route('user_image_store',['course_id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-row">
                                    ...
                                    <table class="table table-responsive-md">
                                        ...
                                        @foreach ($images as $rs)
                                            <tr>
                                                ...
                                                <td><a href="{{route('user_image_delete',['id'=>$rs->id,'course_id'=>$data->id])}}" onclick="return confirm('Record will be delete ! Are you sure?')"><img src="{{ asset('assets') }}/admin/icons/feather/trash-2.svg"></a></td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
