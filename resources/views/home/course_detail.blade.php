                                        ...
                                        <div class="content">
                                            <section class="no_padding">
                                                <div class="container">
                                                    <div class="row">
                                                        <div>
                                                            <h4><b>SIGN IN COURSE</b></h4>
                                                        </div>
                                                        <div
                                                            class="columns_wrap sc_columns columns_nofluid sc_columns_count_3">
                                                            <div
                                                                class="column-1_2 sc_column_item sc_column_item_1 odd first">
                                                                <form class="contact_1"
                                                                      action="{{route('buycourse',['id'=>$data->id])}}"
                                                                      method="post">
                                                                    @csrf
                                                                    <div class="sc_price_block sc_price_block_style_1">

                                                                        <div class="sc_contact_form_info"><br>
                                                                            <h6 class="sc_title sc_title_regular">&nbsp;&nbsp;&nbsp;<b>ORDER
                                                                                    DETAILS</b></h6>
                                                                            <div
                                                                                class="sc_line style_3 sc_line_style_double"></div>
                                                                            <br>
                                                                            <div
                                                                                class="sc_contact_form_item sc_contact_form_field label_over">
                                                                                <input class="column-9_10" type="text"
                                                                                       name="name"
                                                                                       value="{{ Auth::user()->name }}"
                                                                                       placeholder="Name & Surname"
                                                                                       id="contact_form_username"
                                                                                       style="outline: none !important;border-color: black;box-shadow: 0 0 10px black;margin-left: 30px">
                                                                            </div>
                                                                            <br>
                                                                            <div
                                                                                class="sc_contact_form_item sc_contact_form_field label_over">
                                                                            ...
                                                                            <div
                                                                                class="sc_contact_form_item sc_contact_form_field label_over">
                                                                                <input class="column-9_10" type="date"
                                                                    ...
                                                                    <div>
                                                                        &nbsp;&nbsp;&nbsp;<button type="submit"
                                                                                                  class="sc_button sc_button_square sc_button_style_border sc_button_bg_color3 sc_button_size_small">
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    class="sc_price_block sc_price_block_style_2 marked">
                                                                    <div class="sc_contact_form_info"><br>
                                                                        <h6 class="sc_title sc_title_regular">&nbsp;&nbsp;&nbsp;<b>PAYMENT
                                                                                DETAILS | {{$data->month}} Months = {{$data->price}}₺</b></h6>
                                                                        <div
                                                                            class="sc_line style_3 sc_line_style_double"></div>
                                                                        <br>
                                                                        <div
                                                                        ...
                                                                        <div
                                                                            class="sc_contact_form_item sc_contact_form_field label_over">
                                                                            <input class="column-9_10" type="number"
                                                                                   name="cardnumber"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="comment_content">
                                                                                <div class="comment_info">
                                                                                    ...
                                                                                    <div class="reviews_stars_wrap">
                                                                                        @if ($rs->rate>=1)
                                                                                            <i class="reviews_stars_hover"><span
                                                                                                    class="reviews_star"></span></i>
                                                                                        @else
                                                                                            <i class="reviews_stars_bg"><span
                                                                                                    class="reviews_star"></span></i>
                                                                                        @endif
                                                                                ...
                                                                                <div class="comment_text_wrap">
                                                                                    <div class="comment_text">
                                                                                        <strong><i class="icon-user">&nbsp;</i>{{$rs->user->name}}
                                                                                        </strong><br>
